...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_DispatchSystemControl\n");
...
skipGuid:;
	...
	case IrpNotWmi:
		VIRTUSB_KDPRINT1("IrpNotWmi -- MinorFunction: %lu\n", (ULONG)stack->MinorFunction);
	case IrpForward:
	...
	default:
		...
		VIRTUSB_KDPRINT1("MinorFunction: %lu\n", (ULONG)stack->MinorFunction);
		ASSERT(FALSE);
		IoSkipCurrentIrpStackLocation(Irp);
		status = IoCallDriver(fdoData->NextLowerDriver, Irp);
		break;
...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_WmiRegistration\n");
...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_WmiDeRegistration\n");
...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_SetWmiDataItem\n");
...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_SetWmiDataBlock\n");
...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_QueryWmiDataBlock\n");
...
*/
{
	...
	VIRTUSB_KDPRINT("in VirtUsb_QueryWmiRegInfo\n");
