...
#if DBG
#define VIRTUSB_KDPRINT(fmt) DbgPrint("VIRTUSB.SYS: " fmt)
#define VIRTUSB_KDPRINT1(fmt, a1) DbgPrint("VIRTUSB.SYS: " fmt, a1)
#define VIRTUSB_KDPRINT2(fmt, a1, a2) DbgPrint("VIRTUSB.SYS: " fmt, a1, a2)
#define VIRTUSB_KDPRINT3(fmt, a1, a2, a3) DbgPrint("VIRTUSB.SYS: " fmt, a1, a2, a3)
#define VIRTUSB_KDPRINT4(fmt, a1, a2, a3, a4) DbgPrint("VIRTUSB.SYS: " fmt, a1, a2, a3, a4)
#define VIRTUSB_KDPRINT5(fmt, a1, a2, a3, a4, a5) DbgPrint("VIRTUSB.SYS: " fmt, a1, a2, a3, a4, a5)
#else
#define VIRTUSB_KDPRINT(fmt) do {} while(0)
#define VIRTUSB_KDPRINT1(fmt, a1) do {} while(0)
#define VIRTUSB_KDPRINT2(fmt, a1, a2) do {} while(0)
#define VIRTUSB_KDPRINT3(fmt, a1, a2, a3) do {} while(0)
#define VIRTUSB_KDPRINT4(fmt, a1, a2, a3, a4) do {} while(0)
#define VIRTUSB_KDPRINT5(fmt, a1, a2, a3, a4, a5) do {} while(0)
#endif
